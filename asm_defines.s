...
.equ ABILITY_ADDITIVELIGHT, 0x84
.equ ABILITY_BLINDINGENTRANCE, 0x85
.equ ABILITY_CONDUCTOR, 0x86
.equ ABILITY_REFRIGERATE, 0x87
.equ ABILITY_PIXILATE, 0x88
@.equ ABILITY_AERILATE, 0x89
.equ  ABILITY_TIMELESS, 0x89
@.equ ABILITY_NORMALIZE, 0x8A
.equ ABILITY_FERAL, 0x8A
...
.equ ABILITY_PRIMAL, 0xD9
@.equ ABILITY_LIQUIDVOICE, 0xDA
.equ ABILITY_HEEBIEJEEBIES, 0xDA
...
.equ ABILITY_SOLARIZE, 0xF5
@.equ ABILITY_PUNKROCK, 0xF6
.equ ABILITY_CHITTERCHATTER, 0xF6
.equ ABILITY_SANDSPIT, 0xF7
@.equ ABILITY_ICESCALES, 0xF8
.equ ABILITY_COSMOSCONQUEROR, 0xF8
...
//Light Type
.equ MOVE_LAZERFIRE, 0x2FF
.equ MOVE_SEARINGSUN, 0x300
.equ MOVE_SOLARFLARE, 0x301
.equ MOVE_FLASHBANG, 0x302
.equ MOVE_LIGHTSPEEDPUNCH, 0x303
.equ MOVE_FOCUSEDBEAM, 0x304
.equ MOVE_PURITY, 0x305
.equ MOVE_CONCENTRATE, 0x306
.equ MOVE_HALLOWFOCUS, 0x307
.equ MOVE_LIGHTSHIELD, 0x308
.equ MOVE_SERENITY, 0x309
.equ MOVE_LUSTERSHOT, 0x30A
.equ MOVE_FINALLIGHT, 0x30B
.equ MOVE_SUNBEAM, 0x30C
.equ MOVE_RUINOUSLIGHT, 0x30D
.equ MOVE_BLINDED, 0x30E
.equ MOVE_CURINGLIGHT, 0x30F

//Sound Type
.equ MOVE_WARMUP, 0x310
.equ MOVE_DRUMROLL, 0x311
.equ MOVE_STRUM, 0x312
.equ MOVE_MELODY, 0x313
.equ MOVE_SEEDSHAKER, 0x314
.equ MOVE_SUDDENSHOUT, 0x315
.equ MOVE_PITCHPERFECT, 0x316
.equ MOVE_DEAFEN, 0x317
.equ MOVE_FINALE, 0x318
.equ MOVE_ACAPELLA, 0x319
.equ MOVE_FORTISSIMO, 0x31A
.equ MOVE_BEAMEDNOTE, 0x31B
.equ MOVE_HECKLE, 0x31C
.equ MOVE_BLUES, 0x31D
.equ MOVE_JAZZ, 0x31E
.equ MOVE_ROCKNROLL, 0x31F
.equ MOVE_POP, 0x320
.equ MOVE_RAP, 0x321

//Cosmic Type
.equ MOVE_GAMMARAY, 0x322
.equ MOVE_BLACKHOLE, 0x323
.equ MOVE_PULSAR, 0x324
.equ MOVE_FISSION, 0x325
.equ MOVE_FUSION, 0x326
.equ MOVE_METEORSHOWER, 0x327
.equ MOVE_STARBURST, 0x328
.equ MOVE_WARPDRIVE, 0x329
.equ MOVE_WORMHOLE, 0x32A
.equ MOVE_IRRADIATE, 0x32B
.equ MOVE_ASTEROIDBELT, 0x32C
.equ MOVE_COSMICRAY, 0x32D
.equ MOVE_GAMMAPOWER, 0x32E
.equ MOVE_RELATIVITY, 0x32F
.equ MOVE_BIGBANG, 0x330
.equ MOVE_ABDUCT, 0x331
.equ MOVE_NEUTRONSHOT, 0x332

//Mystic Type
.equ MOVE_STANDIN, 0x333
.equ MOVE_FLOURISH, 0x334
.equ MOVE_CONFUZZLE, 0x335
.equ MOVE_BEFUDDLE, 0x336
.equ MOVE_REHEARSAL, 0x337
.equ MOVE_SCREENTIME, 0x338
.equ MOVE_BREAKALEG, 0x339
.equ MOVE_PERFORMANCE, 0x33A
.equ MOVE_SWINDLE, 0x33B
.equ MOVE_INCANTATION, 0x33C
.equ MOVE_PRESTO, 0x33D
.equ MOVE_MAGICMISSILE, 0x33E
.equ MOVE_ENCHANT, 0x33F
.equ MOVE_ARCANEAETHER, 0x340
.equ MOVE_VORTEX, 0x341
.equ MOVE_TRANSMUTE, 0x342
.equ MOVE_CHAOSMAGIC, 0x343

//Beast Type
.equ MOVE_FORAGE, 0x344
.equ MOVE_MAUL, 0x345
.equ MOVE_FERALSTRIKES, 0x346
.equ MOVE_SAVAGE, 0x347
.equ MOVE_CLAW, 0x348
.equ MOVE_HARSHCLAW, 0x349
.equ MOVE_BRUTALCLAW, 0x34A
.equ MOVE_BEASTCHARGE, 0x34B
.equ MOVE_RUPTURE, 0x34C
.equ MOVE_RAWR, 0x34D
.equ MOVE_FERALBITE, 0x34E
.equ MOVE_DIREFLAIL, 0x34F
.equ MOVE_PLAYDEAD, 0x350
.equ MOVE_HUNTERMARK, 0x351
.equ MOVE_ADRENALINE, 0x352
.equ MOVE_BEASTSENSE, 0x353
.equ MOVE_CONCEALMENT, 0x354

//Relic Type
.equ MOVE_PERSEVERANCE, 0x355
.equ MOVE_ENTOMB, 0x356
.equ MOVE_CHISEL, 0x357
.equ MOVE_SNAGCURIO, 0x358
.equ MOVE_SHARDSHOT, 0x359
.equ MOVE_SCRAPE, 0x35A
.equ MOVE_TIMEGEAR, 0x35B
.equ MOVE_RUSTYRIVET, 0x35C
.equ MOVE_COREBLAST, 0x35D
.equ MOVE_HEIRLOOMHIT, 0x35E
.equ MOVE_MAINTENANCE, 0x35F
.equ MOVE_GAURDDRAIN, 0x360
.equ MOVE_REINFORCE, 0x361
.equ MOVE_BOLSTER, 0x362
.equ MOVE_FORTIFY, 0x363
.equ MOVE_WEIGHDOWN, 0x364
.equ MOVE_CAVING, 0x365

//Food Type
.equ MOVE_SALTRUB, 0x366
.equ MOVE_GUMSHOT, 0x367
.equ MOVE_MUNCH, 0x368
.equ MOVE_SYRUPSMACK, 0x369
.equ MOVE_MORNINGMEAL, 0x36A
.equ MOVE_GREEDYGRAB, 0x36B
.equ MOVE_REGROWTH, 0x36C
.equ MOVE_SUGARRUSH, 0x36D
.equ MOVE_FOODCOMA, 0x36E
.equ MOVE_TASTE, 0x36F
.equ MOVE_FEAST, 0x370
.equ MOVE_FLINGFRUIT, 0x371
.equ MOVE_BANQUET, 0x372
.equ MOVE_CHOMP, 0x373
.equ MOVE_DIGEST, 0x374
.equ MOVE_CONSUME, 0x375
.equ MOVE_ORDERUP, 0x376

//Fungus Type
.equ MOVE_SPOREBURST, 0x377
.equ MOVE_PUFFPUNCH, 0x378
.equ MOVE_MYCELIALCAGE, 0x379
.equ MOVE_MUSCARDINE, 0x37A
.equ MOVE_FERMENTEDSPRAY, 0x37B
.equ MOVE_SUPERSPORE, 0x37C
.equ MOVE_AFTEREFFECTS, 0x37D
.equ MOVE_MUSHYSHIELD, 0x37E
.equ MOVE_TRUFFLETOUCH, 0x37F
.equ MOVE_BADTRIP, 0x380
.equ MOVE_DELAYEDGROWTH, 0x381
.equ MOVE_LICHENLEECH, 0x382
.equ MOVE_BLACKMOLD, 0x383
.equ MOVE_PSYCHOSPORE, 0x384
.equ MOVE_MUSHYMESS, 0x385

//Tech Type
.equ MOVE_BITCRUSH, 0x386
.equ MOVE_HARDRESET, 0x387
.equ MOVE_ANTIVIRUS, 0x388
.equ MOVE_MEMORYLEAK, 0x389
.equ MOVE_OVERRIDE, 0x38A
.equ MOVE_WIREWHIP, 0x38B
.equ MOVE_HYDRAULICHIT, 0x38C
.equ MOVE_BRUTEFORCE, 0x38D
.equ MOVE_POWERSURGE, 0x38E
.equ MOVE_SHORTCIRCUIT, 0x38F
.equ MOVE_BURNOUT, 0x390
.equ MOVE_OVERCLOCKING, 0x391
.equ MOVE_COOLDOWN, 0x392
.equ MOVE_OVERCHARGE, 0x393
.equ MOVE_REBOOT, 0x394

//Misc Moves
.equ MOVE_SPINOUT, 0x395
.equ MOVE_MAKEITRAIN, 0x396
.equ MOVE_GEMCANNON, 0x397
.equ MOVE_FACETING, 0x398
.equ MOVE_SHADOWBLAST, 0x399
.equ MOVE_SHADOWDOWN, 0x39A
.equ MOVE_SHADOWSHED, 0x39B
.equ MOVE_SHADOWSTORM, 0x39C
.equ MOVE_SHADOWFLARE, 0x39D
.equ MOVE_SHADOWHOLD, 0x39E
.equ MOVE_SHADOWPANIC, 0x39F
.equ MOVE_SHADOWBREAK, 0x3A0

//Z-Moves
.equ MOVE_BREAKNECK_BLITZ_P, 0x3A1
.equ MOVE_BREAKNECK_BLITZ_S, 0x3A2
.equ MOVE_ALL_OUT_PUMMELING_P, 0x3A3
.equ MOVE_ALL_OUT_PUMMELING_S, 0x3A4
.equ MOVE_SUPERSONIC_SKYSTRIKE_P, 0x3A5
.equ MOVE_SUPERSONIC_SKYSTRIKE_S, 0x3A6
.equ MOVE_ACID_DOWNPOUR_P, 0x3A7
.equ MOVE_ACID_DOWNPOUR_S, 0x3A8
.equ MOVE_TECTONIC_RAGE_P, 0x3A9
.equ MOVE_TECTONIC_RAGE_S, 0x3AA
.equ MOVE_CONTINENTAL_CRUSH_P, 0x3AB
.equ MOVE_CONTINENTAL_CRUSH_S, 0x3AC
.equ MOVE_SAVAGE_SPIN_OUT_P, 0x3AD
.equ MOVE_SAVAGE_SPIN_OUT_S, 0x3AE
.equ MOVE_NEVER_ENDING_NIGHTMARE_P, 0x3AF
.equ MOVE_NEVER_ENDING_NIGHTMARE_S, 0x3B0
.equ MOVE_CORKSCREW_CRASH_P, 0x3B1
.equ MOVE_CORKSCREW_CRASH_S, 0x3B2
.equ MOVE_INFERNO_OVERDRIVE_P, 0x3B3
.equ MOVE_INFERNO_OVERDRIVE_S, 0x3B4
.equ MOVE_HYDRO_VORTEX_P, 0x3B5
.equ MOVE_HYDRO_VORTEX_S, 0x3B6
.equ MOVE_BLOOM_DOOM_P, 0x3B7
.equ MOVE_BLOOM_DOOM_S, 0x3B8
.equ MOVE_GIGAVOLT_HAVOC_P, 0x3B9
.equ MOVE_GIGAVOLT_HAVOC_S, 0x3BA
.equ MOVE_SHATTERED_PSYCHE_P, 0x3BB
.equ MOVE_SHATTERED_PSYCHE_S, 0x3BC
.equ MOVE_SUBZERO_SLAMMER_P, 0x3BD
.equ MOVE_SUBZERO_SLAMMER_S, 0x3BE
.equ MOVE_DEVASTATING_DRAKE_P, 0x3BF
.equ MOVE_DEVASTATING_DRAKE_S, 0x3C0
.equ MOVE_BLACK_HOLE_ECLIPSE_P, 0x3C1
.equ MOVE_BLACK_HOLE_ECLIPSE_S, 0x3C2
.equ MOVE_TWINKLE_TACKLE_P, 0x3C3
.equ MOVE_TWINKLE_TACKLE_S, 0x3C4
.equ MOVE_CATASTROPIKA, 0x3C5
.equ MOVE_10000000_VOLT_THUNDERBOLT, 0x3C6
.equ MOVE_STOKED_SPARKSURFER, 0x3C7
.equ MOVE_EXTREME_EVOBOOST, 0x3C8
.equ MOVE_PULVERIZING_PANCAKE, 0x3C9
.equ MOVE_GENESIS_SUPERNOVA, 0x3CA
.equ MOVE_SINISTER_ARROW_RAID, 0x3CB
.equ MOVE_MALICIOUS_MOONSAULT, 0x3CC
.equ MOVE_OCEANIC_OPERETTA, 0x3CD
.equ MOVE_SPLINTERED_STORMSHARDS, 0x3CE
.equ MOVE_LETS_SNUGGLE_FOREVER, 0x3CF
.equ MOVE_CLANGOROUS_SOULBLAZE, 0x3D0
.equ MOVE_GUARDIAN_OF_ALOLA, 0x3D1
.equ MOVE_SEARING_SUNRAZE_SMASH, 0x3D2
.equ MOVE_MENACING_MOONRAZE_MAELSTROM, 0x3D3
.equ MOVE_LIGHT_THAT_BURNS_THE_SKY, 0x3D4
.equ MOVE_SOUL_STEALING_7_STAR_STRIKE, 0x3D5
...
.equ SPECIES_VAROOM, 0x4ED
.equ SPECIES_REVAVROOM, 0x4EE
.equ SPECIES_TOEDSCOOL, 0x4EF
.equ SPECIES_TOEDSCRUEL, 0x4F0
.equ SPECIES_GIMMIGHOUL, 0x4F1
.equ SPECIES_GHOLDENGO, 0x4F2
.equ SPECIES_BRUTEBONNET, 0x4F3
.equ SPECIES_CRYSONIX, 0x4F4
.equ SPECIES_SHDWLUGIA, 0x4F5
.equ SPECIES_SHDWHO_OH, 0x4F6

.equ SPECIES_VENUSAUR_GIGA, 0x4F7
.equ SPECIES_CHARIZARD_GIGA, 0x4F8
.equ SPECIES_BLASTOISE_GIGA, 0x4F9
.equ SPECIES_BUTTERFREE_GIGA, 0x4FA
.equ SPECIES_PIKACHU_GIGA, 0x4FB
.equ SPECIES_MEOWTH_GIGA, 0x4FC
.equ SPECIES_MACHAMP_GIGA, 0x4FD
.equ SPECIES_GENGAR_GIGA, 0x4FE
.equ SPECIES_KINGLER_GIGA, 0x4FF
.equ SPECIES_LAPRAS_GIGA, 0x500
.equ SPECIES_EEVEE_GIGA, 0x501
.equ SPECIES_SNORLAX_GIGA, 0x502
.equ SPECIES_GARBODOR_GIGA, 0x503
.equ SPECIES_MELMETAL_GIGA, 0x504
.equ SPECIES_RILLABOOM_GIGA, 0x505
.equ SPECIES_CINDERACE_GIGA, 0x506
.equ SPECIES_INTELEON_GIGA, 0x507
.equ SPECIES_CORVIKNIGHT_GIGA, 0x508
.equ SPECIES_ORBEETLE_GIGA, 0x509
.equ SPECIES_DREDNAW_GIGA, 0x50A
.equ SPECIES_COALOSSAL_GIGA, 0x50B
.equ SPECIES_FLAPPLE_GIGA, 0x50C
.equ SPECIES_APPLETUN_GIGA, 0x50D
.equ SPECIES_SANDACONDA_GIGA, 0x50E
.equ SPECIES_TOXTRICITY_GIGA, 0x50F
.equ SPECIES_TOXTRICITY_LOW_KEY_GIGA, 0x510
.equ SPECIES_CENTISKORCH_GIGA, 0x511
.equ SPECIES_HATTERENE_GIGA, 0x512
.equ SPECIES_GRIMMSNARL_GIGA, 0x513
.equ SPECIES_ALCREMIE_GIGA, 0x514
.equ SPECIES_COPPERAJAH_GIGA, 0x515
.equ SPECIES_DURALUDON_GIGA, 0x516
.equ SPECIES_URSHIFU_SINGLE_GIGA, 0x517
.equ SPECIES_URSHIFU_RAPID_GIGA, 0x518
