...
//Z-Moves
.equ MOVE_BREAKNECK_BLITZ_P, 0x399
.equ MOVE_BREAKNECK_BLITZ_S, 0x39A
.equ MOVE_ALL_OUT_PUMMELING_P, 0x39B
.equ MOVE_ALL_OUT_PUMMELING_S, 0x39C
.equ MOVE_SUPERSONIC_SKYSTRIKE_P, 0x39D
.equ MOVE_SUPERSONIC_SKYSTRIKE_S, 0x39E
.equ MOVE_ACID_DOWNPOUR_P, 0x39F
.equ MOVE_ACID_DOWNPOUR_S, 0x3A0
.equ MOVE_TECTONIC_RAGE_P, 0x3A1
.equ MOVE_TECTONIC_RAGE_S, 0x3A2
.equ MOVE_CONTINENTAL_CRUSH_P, 0x3A3
.equ MOVE_CONTINENTAL_CRUSH_S, 0x3A4
.equ MOVE_SAVAGE_SPIN_OUT_P, 0x3A5
.equ MOVE_SAVAGE_SPIN_OUT_S, 0x3A6
.equ MOVE_NEVER_ENDING_NIGHTMARE_P, 0x3A7
.equ MOVE_NEVER_ENDING_NIGHTMARE_S, 0x3A8
.equ MOVE_CORKSCREW_CRASH_P, 0x3A9
.equ MOVE_CORKSCREW_CRASH_S, 0x3AA
.equ MOVE_INFERNO_OVERDRIVE_P, 0x3AB
.equ MOVE_INFERNO_OVERDRIVE_S, 0x3AC
.equ MOVE_HYDRO_VORTEX_P, 0x3AD
.equ MOVE_HYDRO_VORTEX_S, 0x3AE
.equ MOVE_BLOOM_DOOM_P, 0x3AF
.equ MOVE_BLOOM_DOOM_S, 0x3B0
.equ MOVE_GIGAVOLT_HAVOC_P, 0x3B1
.equ MOVE_GIGAVOLT_HAVOC_S, 0x3B2
.equ MOVE_SHATTERED_PSYCHE_P, 0x3B3
.equ MOVE_SHATTERED_PSYCHE_S, 0x3B4
.equ MOVE_SUBZERO_SLAMMER_P, 0x3B5
.equ MOVE_SUBZERO_SLAMMER_S, 0x3B6
.equ MOVE_DEVASTATING_DRAKE_P, 0x3B7
.equ MOVE_DEVASTATING_DRAKE_S, 0x3B8
.equ MOVE_BLACK_HOLE_ECLIPSE_P, 0x3B9
.equ MOVE_BLACK_HOLE_ECLIPSE_S, 0x3BA
.equ MOVE_TWINKLE_TACKLE_P, 0x3BB
.equ MOVE_TWINKLE_TACKLE_S, 0x3BC
.equ MOVE_CATASTROPIKA, 0x3BD
.equ MOVE_10000000_VOLT_THUNDERBOLT, 0x3BE
.equ MOVE_STOKED_SPARKSURFER, 0x3BF//Paralyze Target
.equ MOVE_EXTREME_EVOBOOST, 0x3C0//Double Ancient Power
.equ MOVE_PULVERIZING_PANCAKE, 0x3C1
.equ MOVE_GENESIS_SUPERNOVA, 0x3C2//Sets up Psychic Terrain
.equ MOVE_SINISTER_ARROW_RAID, 0x3C3
.equ MOVE_MALICIOUS_MOONSAULT, 0x3C4
.equ MOVE_OCEANIC_OPERETTA, 0x3C5
.equ MOVE_SPLINTERED_STORMSHARDS, 0x3C6//Removes Terrain
.equ MOVE_LETS_SNUGGLE_FOREVER, 0x3C7
.equ MOVE_CLANGOROUS_SOULBLAZE, 0x3C8//Ancient Power
.equ MOVE_GUARDIAN_OF_ALOLA, 0x3C9
.equ MOVE_SEARING_SUNRAZE_SMASH, 0x3CA
.equ MOVE_MENACING_MOONRAZE_MAELSTROM, 0x3CB
.equ MOVE_LIGHT_THAT_BURNS_THE_SKY, 0x3CC
.equ MOVE_SOUL_STEALING_7_STAR_STRIKE, 0x3CD
