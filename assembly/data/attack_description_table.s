...
.word DESC_LAZER_FIRE
.word DESC_SEARING_SUN
.word DESC_SOLAR_FLARE
.word DESC_FLASH_BANG
.word DESC_LIGHTSPEED_PUNCH
.word DESC_FOCUSED_BEAM
.word DESC_PURITY
.word DESC_CONCENTRATE
.word DESC_HALLOW_FOCUS
.word DESC_LIGHT_SHIELD
.word DESC_SERENITY
.word DESC_LUSTERSHOT
.word DESC_FINALLIGHT
.word DESC_SUNBEAM
.word DESC_RUINOUSLIGHT
.word DESC_BLINDED
.word DESC_CURINGLIGHT
.word DESC_WARMUP
.word DESC_DRUMROLL
.word DESC_STRUM
.word DESC_MELODY
.word DESC_SEEDSHAKER
.word DESC_SUDDENSHOUT
.word DESC_PITCHPERFECT
.word DESC_DEAFEN
.word DESC_FINALE
.word DESC_ACAPELLA
.word DESC_FORTISSIMO
.word DESC_BEAMEDNOTE
.word DESC_HECKLE
.word DESC_BLUES
.word DESC_JAZZ
.word DESC_ROCKNROLL
...
.word DESC_FISSION
.word DESC_FUSION
.word DESC_METEORSHOWER
.word DESC_STARBURST
.word DESC_WARPDRIVE
.word DESC_WORMHOLE
.word DESC_IRRADIATE
.word DESC_ASTEROIDBELT
.word DESC_COSMICRAY
.word DESC_GAMMAPOWER
.word DESC_RELATIVITY
.word DESC_BIGBANG
.word DESC_ABDUCT
.word DESC_NEUTRONSHOT
.word DESC_STANDIN
.word DESC_FLOURISH
.word DESC_CONFUZZLE
.word DESC_BEFUDDLE
.word DESC_REHEARSAL
.word DESC_SCREENTIME
.word DESC_BREAKALEG
.word DESC_PERFORMANCE
.word DESC_SWINDLE
.word DESC_INCANTATION
.word DESC_PRESTO
.word DESC_MAGICMISSILE
.word DESC_ENCHANT
.word DESC_ARCANEAETHER
.word DESC_VORTEX
.word DESC_TRANSMUTE
.word DESC_CHAOSMAGIC
.word DESC_FORAGE
.word DESC_MAUL
.word DESC_FERALSTRIKES
.word DESC_SAVAGE
.word DESC_CLAW
.word DESC_HARSHCLAW
.word DESC_BRUTALCLAW
.word DESC_BEASTCHARGE
.word DESC_RUPTURE
.word DESC_RAWR
.word DESC_FERALBITE
.word DESC_DIREFLAIL
.word DESC_PLAYDEAD
.word DESC_HUNTERMARK
.word DESC_ADRENALINE
.word DESC_BEASTSENSE
.word DESC_CONCEALMENT
.word DESC_PERSEVERANCE
.word DESC_ENTOMB
.word DESC_CHISEL
.word DESC_SNAGCURIO
.word DESC_SHARDSHOT
.word DESC_SCRAPE
.word DESC_TIMEGEAR
.word DESC_RUSTYRIVET
.word DESC_COREBLAST
.word DESC_HEIRLOOMHIT
.word DESC_MAINTENANCE
.word DESC_GAURDDRAIN
.word DESC_REINFORCE
.word DESC_BOLSTER
.word DESC_FORTIFY
.word DESC_WEIGHDOWN
...
.word DESC_GUMSHOT
.word DESC_MUNCH
.word DESC_SYRUPSMACK
.word DESC_MORNINGMEAL
.word DESC_GREEDYGRAB
.word DESC_REGROWTH
.word DESC_SUGARRUSH
.word DESC_FOODCOMA
.word DESC_TASTE
.word DESC_FEAST
.word DESC_FLINGFRUIT
.word DESC_BANQUET
.word DESC_CHOMP
.word DESC_DIGEST
.word DESC_CONSUME
.word DESC_ORDERUP
.word DESC_SPOREBURST
.word DESC_PUFFPUNCH
.word DESC_MYCELIALCAGE
.word DESC_MUSCARDINE
.word DESC_FERMENTEDSPRAY
.word DESC_SUPERSPORE
.word DESC_AFTEREFFECTS
.word DESC_MUSHYSHIELD
.word DESC_TRUFFLETOUCH
.word DESC_BADTRIP
.word DESC_DELAYEDGROWTH
.word DESC_LICHENLEECH
.word DESC_BLACKMOLD
.word DESC_PSYCHOSPORE
.word DESC_MUSHYMESS
.word DESC_BITCRUSH
.word DESC_HARDRESET
.word DESC_ANTIVIRUS
.word DESC_MEMORYLEAK
.word DESC_OVERRIDE
.word DESC_WIREWHIP
.word DESC_HYDRAULICHIT
.word DESC_BRUTEFORCE
.word DESC_POWERSURGE
.word DESC_SHORTCIRCUIT
.word DESC_BURNOUT
.word DESC_OVERCLOCKING
.word DESC_COOLDOWN
...
.word DESC_GEMCANNON
.word DESC_FACETING
.word DESC_SHADOWBLAST
.word DESC_SHADOWDOWN
.word DESC_SHADOWSHED
.word DESC_SHADOWSTORM
.word DESC_SHADOWFLARE
.word DESC_SHADOWHOLD
.word DESC_SHADOWPANIC
.word DESC_SHADOWBREAK
.word DESC_RAGEFIST
