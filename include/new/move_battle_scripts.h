...
extern const u8 ThirdTypeAddedStringAttacker[];
...
extern const u8 PsychoSporeLayString[];
extern const u8 MushyMessLayString[];
...
extern const u8 BattleScript_MMHurt[];
...
extern const u8 BattleScript_PSConfuse[];
extern const u8 BattleScript_TSAbsorb[];
extern const u8 BattleScript_PSAbsorb[];
extern const u8 BattleScript_MMAbsorb[];
